        ...
        <div className="mx-auto w-full max-w-[950px]">
          <RevealAnimation delay={0.1}>
            <div className="space-y-3 py-8">
              ...
              <p>
                ...
                Cezonial Solutions is registered in the Trade and Companies Register under number 000000000. <br />
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-3 py-8">
              ...
              <p>
                This website has been designed and developed byCezonial Solutions Design Studio. <br />
                Website:{' '}
                <Link href="/" className="text-primary-500">
