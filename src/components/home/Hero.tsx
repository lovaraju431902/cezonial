      ...
      <div className="mx-auto max-w-[1440px] ">
        <div className="relative top-4 h-auto overflow-hidden rounded-[20px] bg-linear-[180deg,_#B3C3DA_0%,_#93A5BE_100%] lg:top-8">
          <figure
            ...
            aria-hidden="true">
            <Image src={heroDotVectorBg} alt="Decorative background pattern" priority />
          </figure>
            ...
            <div className="flex flex-col items-center justify-center gap-y-16 pt-36 md:flex-row md:pt-40 lg:pt-[150px] xl:pt-[170px]">
              <div>
                <div className="mb-6 space-y-2 text-center md:mb-8 md:space-y-4 md:text-left">
                  <RevealAnimation delay={0.1} instant>
                    <h1 className="dark:text-secondary max-w-full lg:max-w-[507px]">Websites made for the future!</h1>
                  </RevealAnimation>
                ...
                <div className="mb-10 flex flex-col items-center justify-center gap-y-5 sm:flex-row sm:gap-x-4 md:justify-start lg:mb-14">
                  <div className="flex -space-x-3.5">
                    <RevealAnimation delay={0.1} direction="right" offset={50}>
                      <figure>
                        <Image
                    ...
                    <RevealAnimation delay={0.15} direction="right" offset={50}>
                      <figure>
                        <Image
                    ...
                    <RevealAnimation delay={0.25} direction="right" offset={50}>
                  ...
                  <div>
                    <RevealAnimation delay={0.25} offset={40}>
              ...
              <RevealAnimation delay={0.2}>
                <figure className="w-full max-w-[643px]">
                  <Image src={heroThumbnail} alt="App showcase illustration" className="size-full object-cover" priority />
                </figure>
              </RevealAnimation>
            </div>
          </div>
