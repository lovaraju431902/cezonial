      ...
      <div className="main-container relative">
        <RevealAnimation delay={0.1}>
          <h2
            ...
            Cezonial Solutions resumes have helped users land jobs at top companies.
          </h2>
        </RevealAnimation>
        <RevealAnimation delay={0.2} instant>
          <div
            className="mt-14 overflow-hidden"
            aria-label="Logos of companies whereCezonial Solutions users have found employment">
