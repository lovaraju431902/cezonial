...
const contactInfoItems = [
  {
    ...
    icon: homeIcon,
    title: 'Our Address',
    content: 'Velpur Rd, opposite V MAX THEATRES, Venkatarayapuram, Tanuku, Sajjapuram, Andhra Pradesh 534122',
    link: 'https://www.google.com/maps?q=Cezonal+Solutions,+opposite+VN+Palace,+Venkatarayapuram,+Tanuku,+Sajjapuram,+Andhra+Pradesh+534122&ftid=0x3a37b7ac4526dff5:0x2a595c8af660ebcb',
  ...
  },
  {
    ...
    icon: mailIcon,
    title: 'Email Us',
    content: 'info@cezonal.com',
    link: 'mailto:info@cezonal.com',
