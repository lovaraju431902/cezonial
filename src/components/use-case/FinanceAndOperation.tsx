        ...
        <div className="space-y-[70px]">
          ...
          <div className="space-y-3">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                Cezonial Solutions is designed to serve a wide range of teams and industries. Whether you&apos;re managing data,
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  From roadmap planning to feature tracking, product teams useCezonial Solutions to keep everyone aligned and
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Cezonial Solutions helps marketers connect strategy to results, with built-in analytics and collaborative tools
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Cezonial Solutions gives leadership teams the visibility they need across every department—all in one unified
                  view.
                </p>
              </RevealAnimation>
            </div>
            ...
            <div className="space-y-2">
              ...
              <RevealAnimation delay={0.2}>
                <p>
                  ...
                  <br />
                  Even small teams can get big results. UseCezonial Solutions to manage your pipeline, track progress, and
